...
if __name__ == "__main__":
    ...
    full_ft_reconstructed_image = Image(f"{eval_dir}/full_finetuning_reconstruction.png", device)
    psnr = peak_signal_noise_ratio(reference_image.orig_data_npy, full_ft_reconstructed_image.orig_data_npy)
    print("full FT PSNR: ", psnr)
