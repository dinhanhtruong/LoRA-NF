...
from util import SDFDataset, listdir_by_time, edit_region_percentage_to_normalized_bounds, mape_loss, mean_relative_l2, save_mesh, sort_files_with_number_at_end, Image
import wandb
...
# ### LORA EDITING ###
# edit_region_in_percentages = [0, 100, 0, 88] #(y_low, y_high, x_low, x_high)
# log_wandb = True
lora_config = { # shared across different frames
    ...
    # "grid_resolution": -1, # number of grid cells per axis. NOTE: not used for image editing
    # "edit_region": edit_region_percentage_to_normalized_bounds(*edit_region_in_percentages)  #(y_low, y_high, x_low, x_high) in [-1,1]^2 space: (% - 0.5)*2
}
# ##################
